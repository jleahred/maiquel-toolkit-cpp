...
* Each status, can have especific properties +
  This is special interesting to work in +RIIA+ style
...
* If no macro is defined on +fsm+ file, the system will write the macro name with prefix +fsm_gen_+ on c++ code +
