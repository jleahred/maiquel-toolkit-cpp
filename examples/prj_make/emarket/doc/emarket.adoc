...
digraph dfd0_graph {
 ...
 CLIENT_out -> emarket [label = "rq_nw" color=red];
 CLIENT_out -> emarket [label = "rq_md" color=red];
 CLIENT_out -> emarket [label = "rq_cc" color=red];

 CLIENT_out -> emarket [label = "rq_prod_list" color=red];
 CLIENT_out -> emarket [label = "rq_init_prices_best" color=red];
 CLIENT_out -> emarket [label = "rq_init_prices_queue" color=red];


emarket -> CLIENT_in   [label = "cf_xx" color=red];

emarket -> CLIENT_in   [label = "rj_xx" color=red];


emarket -> CLIENT_in   [label = "cf_ex" color=red];

emarket -> CLIENT_in   [label = "prices" color=red];
emarket -> CLIENT_in   [label = "cf_prod_list" color=red];
emarket -> CLIENT_in   [label = "cf_init_prices_best" color=red];
emarket -> CLIENT_in   [label = "cf_init_prices_queue" color=red];
...
CLIENT -> check_rq [label=rq_init_prices_xxx color=red];

check_rq -> book_ord [label=oms_rq_xx];
check_rq -> CLIENT [label=rj_xx color=red];
check_rq -> book_ord [label=rq_init_prices_xxx color=red];
...
order -> book_ord [label=price_update color=red]

book_ord -> order [label=cf_ex]
book_ord -> order [label=oms_rq_xx]

book_ord -> CLIENT [label=prices_xxx color=red]

book_ord -> CLIENT [label=init_prices_xxx color=red]

order -> CLIENT [label=cf_xx]
order -> CLIENT [label=rj_xx]
order -> CLIENT [label=cf_ex]

config -> check_rq [label=products color=red]
