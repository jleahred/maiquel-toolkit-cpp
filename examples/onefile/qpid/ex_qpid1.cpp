...
int main(int /*argc*/, char** /*argv*/)
{
    ...
    try
    {
        ...
        mtk::CountPtr< mtk::handle_qpid_exchange_receiver> hqpidr =
                                            mtk::get_from_factory<mtk::handle_qpid_exchange_receiver>(mtk::make_tuple(g_url, g_address, filter, mtk::QUEUE__DEFAULT_RECEPTOR_CONFIG));
        hqpidr->__impl->signalMessage.connect(on_message);
        //-----------------------------------------------------------------------------------------------------
