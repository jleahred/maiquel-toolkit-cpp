#include "sockets/tcp_base_socket_writelock.h"
...
class tcp_client_stringseparator :  public mtk::tcp_pstringseparator<
                            mtk::tcp_client<mtk::tcp_base_socket_writelock> >
{
    mtk::non_copyable noncopy;
public:
    tcp_client_stringseparator(const std::string& _name, const std::string& _separator)
            : mtk::tcp_pstringseparator<mtk::tcp_client<mtk::tcp_base_socket_writelock> >(_name, _separator) {};

};


class tcp_servermono_stringseparator :  public mtk::tcp_pstringseparator<
                            mtk::tcp_server_mono<mtk::tcp_base_socket_writelock> >
{
    mtk::non_copyable noncopy;
public:
tcp_servermono_stringseparator(const std::string& _name, const std::string& _separator)
            : mtk::tcp_pstringseparator<mtk::tcp_server_mono<mtk::tcp_base_socket_writelock> >(_name, _separator) {};
};
...
tcp_client_stringseparator         tcp_client("prclient", "\n\r");
tcp_servermono_stringseparator     tcp_server("prserver", "\n\r");
...
int  main(int /*argc*/, char** /*argv[]*/)
{
   ...
   try
   {
        ...
        //  INIT   ------------------------------------------------------
            ...
            tcp_client.connect("127.0.0.1", 22302);
