...
void MainWindow::on_pbSendMessage_clicked()
{
    ...
    mtk::CountPtr< mtk::mtkqpid_sender2 > sender = mtk::get_from_factory< mtk::mtkqpid_sender2 >(mtk::make_tuple(   mtk::t_qpid_url(ui->lblUrl->text().toStdString()),
                                                                                                                    mtk::t_qpid_address(ui->leAddress->text().toStdString()),
                                                                                                                    mtk::QUEUE__DEFAULT_SENDER_CONFIG));
...
void MainWindow::on_pbConnect_clicked()
{
    ...
    MTK_CONNECT_THIS(handle_qpid_receiver->__impl->signalMessage, OnReceivedMessage)
}
