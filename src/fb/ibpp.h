...
namespace IBPP
{
	...
	* can create, read and write Interbase Arrays, as a whole or in slices. */
	...
	public:
		...
		virtual void Set(int, const mtk::dtDateTime    &) = 0;            //  JLE
		virtual void Set(int, const mtk::dtTimeQuantity&) = 0;            //  JLE
		...
		virtual bool Get(int, mtk::nullable<mtk::dtDateTime    >&) = 0;            //  JLE
		virtual bool Get(int, mtk::nullable<mtk::dtTimeQuantity>&) = 0;            //  JLE
		...
		virtual bool Get(const std::string&, mtk::nullable<mtk::dtDateTime    >&) = 0;            //  JLE
		virtual bool Get(const std::string&, mtk::nullable<mtk::dtTimeQuantity>&) = 0;            //  JLE
