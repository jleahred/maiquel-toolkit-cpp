...
public:
    ...
    void Set(int, const mtk::dtDateTime    &);            //  JLE
    void Set(int, const mtk::dtTimeQuantity&);            //  JLE
    ...
    bool Get(int, mtk::nullable<mtk::dtDateTime    >&);            //  JLE
    bool Get(int, mtk::nullable<mtk::dtTimeQuantity>&);            //  JLE
    ...
    bool Get(const std::string&, mtk::nullable<mtk::dtDateTime    >&);            //  JLE
    bool Get(const std::string&, mtk::nullable<mtk::dtTimeQuantity>&);            //  JLE
