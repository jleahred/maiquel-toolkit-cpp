...
find {docdir}/../ -name *.cpp -or -name *.h -or -name *.hpp -or -name *.msg -or -name *.fsm |  grep -v /fb/ | grep -v /yaml/ | grep -v /pcre/ | grep -v msg* | wc -l
...
find {docdir}/../ -name *.cpp -or -name *.h -or -name *.hpp -or -name *.msg -or -name *.fsm | grep -v /fb/ | grep -v /yaml/ | grep -v /pcre/ | grep -v msg* | xargs cat | wc -l
