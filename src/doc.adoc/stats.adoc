...
find {docdir}/../ -name *.cpp -or -name *.h -or -name *.hpp -or -name *.msg -or -name *.fsm |  grep -v /fb/ | grep -v /yaml/ | grep -v /pcre/ | grep -v 'msg_*' | wc -l
...
find {docdir}/../ -name *.cpp -or -name *.h -or -name *.hpp -or -name *.msg -or -name *.fsm | grep -v /fb/ | grep -v /yaml/ | grep -v /pcre/ | grep -v 'msg_.*cpp' | grep -v 'msg_.*h' | xargs cat | wc -l
...
echo '| # files  | '
find {docdir}/../../examples/prj_make -name *.cpp -or -name *.h -or -name *.hpp -or -name *.msg -or -name *.fsm | grep -v '.*tcp' | wc -l

echo '| # lines  | '
find {docdir}/../../examples/prj_make -name *.cpp -or -name *.h -or -name *.hpp -or -name *.msg -or -name *.fsm| grep -v 'msg_.*cpp' | grep -v 'msg_.*h' | grep -v '.*tcp' | xargs cat | wc -l
...
echo '+'
echo '--------------'
find {docdir}/../ -name *.cpp -or -name *.h -or -name *.hpp -or -name *.msg -or -name *.fsm | grep -v /fb/ | grep -v /yaml/ | grep -v /pcre/ | grep -v 'msg_*' | xargs wc -l | sort -nr -k1 | head -15
