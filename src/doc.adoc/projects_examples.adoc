...
* This process can work on two different configurations
.. Receiving the account grants and sending the confirmations (a request can be responded by several +account managers+, so it's not possible to work with request response pattern)
...
** +^+  and +$+ indicating beginning and end of string, will be added by program. Do not add them yourself
