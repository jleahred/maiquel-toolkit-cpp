...
* In case of not receiving the next response (timeout) or we will receive an incorrect partial response (bad secuence number), the system will cancel the listener to the response and will emit an alarm
