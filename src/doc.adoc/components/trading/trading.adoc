...
* It's allowed to request consecutive modifications and consecutive cancellations
+
...
==== Cli Orders  MK
  ...
  components/trading/trd_cli_mk.h
  components/trading/trd_cli_mk.cpp


* This component has been generated with +fsm_gen+ from +trd_cli_mk.fsm+
* It will control the flow and keep historic per limit simple order
* It's allowed to request consecutive modifications and consecutive cancellations
+
...
-----------
include::../../../components/trading/trd_cli_mk.dot[]
------------
+
* The interfaz is...
+
...
[source,{cpp}]
----
include::../../../components/trading/trd_cli_mk.fsm[]
----
...
----
+
* Look the return reference on +get_sig_new_order_ls_created(void)+. It means, you have to use it inmediatly, never save the reference for a future use in a different part of program
