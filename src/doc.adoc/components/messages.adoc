...
+
|=====================
| REP.<client>.<machine>.<process_uuid>.<request_code>#   |    Request responses
...
* It's defined on +src/components/msg_common.msg+
* Secuence
.. Multiresponse suscription
.. Send request
.. Receiving responses (with secuence number)
.. Last response or timeout received
* Next information is fromMore information and examples on document +mtk/Components/Request response pattern+
