...
* This behavior gives the oportunity to a different +tree_server+ instance, to check and send response (if so). In this case, +tree_servers+ will work in parallel
