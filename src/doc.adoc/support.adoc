...
* +async_signal_xx+ receive a signal on constructor
* +async_signal_xx+ will connect this signal to receive all events
* This events will be rethrown later asynchronously
