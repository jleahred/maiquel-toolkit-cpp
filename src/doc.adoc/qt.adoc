...
* You have a minimum example at +examples/qt/ex_min_qt/+
...
<3> +MainWindow+ will receive signals (almost the exception and notifications configured previously and on +main.cpp+)
