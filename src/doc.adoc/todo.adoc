...
* +Call later+ with bigger precision
* +Call later+ checking pending calls. Warning on 50, stop con 500
* Attention to signal/slot and exceptions breaking the program flow. Now, when it happends, pending signals will not be call
