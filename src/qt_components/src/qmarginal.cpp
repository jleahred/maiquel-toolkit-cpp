    ...
    if (item)
    {
        ...
        else
        {
            ...
            if(quantity.GetIntCode() != 0)     //  provisional, remove it
            {
                ...
                mtk::trd::trd_cli_ord_book::rq_nw_ls_manual(product_code, bs, pos, account, "cli_ref");
            }
    ...
    if (item)
    {
        ...
        else
        {
            ...
            if(quantity.GetIntCode() != 0)
            {
                ...
                mtk::trd::msg::sub_position_ls     pos(price, quantity);
                mtk::trd::msg::sub_account_info    account("CIMD", "temp_account");
                mtk::trd::trd_cli_ord_book::rq_nw_ls_manual(product_code, bs, pos, account, "cli_ref", true);
            }
            else
            {
                //   nothing
    ...
    if (item)
    {
        ...
        else
        {
            ...
            if(quantity.GetIntCode() != 0)     //  provisional, remove it
            {
                ...
                mtk::trd::msg::sub_account_info    account("CIMD", "temp_account");
                mtk::trd::trd_cli_ord_book::rq_nw_mk_manual(product_code, bs, pos, account, "cli_ref");
            }
            else        //  provisional, remove it
            {
