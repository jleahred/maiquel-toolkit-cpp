...
void  sub_position_ls::check_recomended(void) const
{
...
void  RQ_XX_LS::check_recomended(void) const
{
...
void  RQ_MD_LS::check_recomended(void) const
{
...
void  RQ_CC_LS::check_recomended(void) const
{
...
void  CF_XX_LS::check_recomended(void) const
{
...
void  CF_NW_LS::check_recomended(void) const
{
...
void  CF_MD_LS::check_recomended(void) const
{
...
void  CF_CC_LS::check_recomended(void) const
{
...
void  CF_EX_LS::check_recomended(void) const
{
...
RJ_XX_LS::RJ_XX_LS ( const CF_XX_LS&  parent,   const sub_position_ls&  _request_pos)
    :  CF_XX_LS(parent),   request_pos(_request_pos) 
...
void  RJ_XX_LS::check_recomended(void) const
{
...
void  RJ_NW_LS::check_recomended(void) const
{
...
void  RJ_MD_LS::check_recomended(void) const
{
...
void  RJ_CC_LS::check_recomended(void) const
{
...
void  CF_ST_LS::check_recomended(void) const
{
...
sub_position_ls__qpid_map::sub_position_ls__qpid_map (   const mtk::FixedNumber&  _price,   const mtk::FixedNumber&  _quantity,   const std::string&  _cli_ref)
      :  m_static( 
   _price,
   _quantity,
   _cli_ref) 
...
RQ_XX_LS__qpid_map::RQ_XX_LS__qpid_map ( const RQ_XX&  parent,   const sub_position_ls&  _request_pos)
      :  m_static( 
parent,
   _request_pos) 
    {  
...
RQ_NW_LS__qpid_map::RQ_NW_LS__qpid_map ( const RQ_XX_LS&  parent)
      :  m_static( 
parent) 
    {  
    }
...
RQ_MD_LS__qpid_map::RQ_MD_LS__qpid_map ( const RQ_XX_LS&  parent)
      :  m_static( 
parent) 
    {  
    }
    ...
    qpid::types::Variant::Map   RQ_MD_LS__qpid_map::qpidmsg_codded_as_qpid_map (void) const
    {   qpid::types::Variant::Map result;  __internal_add2map(result, *this);  return result;  }

    //    generate_class_qpid_variant_in_impl
    
RQ_CC_LS__qpid_map::RQ_CC_LS__qpid_map ( const RQ_XX_LS&  parent)
      :  m_static( 
parent) 
    {  
    }
    ...
    qpid::types::Variant::Map   RQ_CC_LS__qpid_map::qpidmsg_codded_as_qpid_map (void) const
    {   qpid::types::Variant::Map result;  __internal_add2map(result, *this);  return result;  }

    //    generate_class_qpid_variant_in_impl
    
CF_XX_LS__qpid_map::CF_XX_LS__qpid_map ( const CF_XX&  parent,   const sub_position_ls&  _market_pos)
      :  m_static( 
parent,
   _market_pos) 
    {  
...
CF_NW_LS__qpid_map::CF_NW_LS__qpid_map ( const CF_XX_LS&  parent)
      :  m_static( 
parent) 
    {  
    }
    ...
    qpid::types::Variant::Map   CF_NW_LS__qpid_map::qpidmsg_codded_as_qpid_map (void) const
    {   qpid::types::Variant::Map result;  __internal_add2map(result, *this);  return result;  }

    //    generate_class_qpid_variant_in_impl
    
CF_MD_LS__qpid_map::CF_MD_LS__qpid_map ( const CF_XX_LS&  parent)
      :  m_static( 
parent) 
    {  
    }
    ...
    qpid::types::Variant::Map   CF_MD_LS__qpid_map::qpidmsg_codded_as_qpid_map (void) const
    {   qpid::types::Variant::Map result;  __internal_add2map(result, *this);  return result;  }

    //    generate_class_qpid_variant_in_impl
    
CF_CC_LS__qpid_map::CF_CC_LS__qpid_map ( const CF_XX_LS&  parent)
      :  m_static( 
parent) 
    {  
    }
    ...
    qpid::types::Variant::Map   CF_CC_LS__qpid_map::qpidmsg_codded_as_qpid_map (void) const
    {   qpid::types::Variant::Map result;  __internal_add2map(result, *this);  return result;  }

    //    generate_class_qpid_variant_in_impl
    
CF_EX_LS__qpid_map::CF_EX_LS__qpid_map ( const CF_XX_LS&  parent,   const sub_exec_conf&  _executed_pos)
      :  m_static( 
parent,
   _executed_pos) 
    {  
    ...
    qpid::types::Variant::Map   CF_EX_LS__qpid_map::qpidmsg_codded_as_qpid_map (void) const
    {   qpid::types::Variant::Map result;  __internal_add2map(result, *this);  return result;  }

    //    generate_class_qpid_variant_in_impl
    
RJ_XX_LS__qpid_map::RJ_XX_LS__qpid_map ( const CF_XX_LS&  parent,   const sub_position_ls&  _request_pos)
      :  m_static( 
parent,
   _request_pos) 
    {  
...
RJ_NW_LS__qpid_map::RJ_NW_LS__qpid_map ( const RJ_XX_LS&  parent)
      :  m_static( 
parent) 
    {  
    }
    ...
    qpid::types::Variant::Map   RJ_NW_LS__qpid_map::qpidmsg_codded_as_qpid_map (void) const
    {   qpid::types::Variant::Map result;  __internal_add2map(result, *this);  return result;  }

    //    generate_class_qpid_variant_in_impl
    
RJ_MD_LS__qpid_map::RJ_MD_LS__qpid_map ( const RJ_XX_LS&  parent)
      :  m_static( 
parent) 
    {  
    }
    ...
    qpid::types::Variant::Map   RJ_MD_LS__qpid_map::qpidmsg_codded_as_qpid_map (void) const
    {   qpid::types::Variant::Map result;  __internal_add2map(result, *this);  return result;  }

    //    generate_class_qpid_variant_in_impl
    
RJ_CC_LS__qpid_map::RJ_CC_LS__qpid_map ( const RJ_XX_LS&  parent)
      :  m_static( 
parent) 
    {  
    }
    ...
    qpid::types::Variant::Map   RJ_CC_LS__qpid_map::qpidmsg_codded_as_qpid_map (void) const
    {   qpid::types::Variant::Map result;  __internal_add2map(result, *this);  return result;  }

    //    generate_class_qpid_variant_in_impl
    
CF_ST_LS__qpid_map::CF_ST_LS__qpid_map ( const CF_XX_LS&  parent,   const mtk::msg::sub_gen_response_location&  _gen_response_location)
      :  m_static( 
parent,
   _gen_response_location) 
    ...
    qpid::types::Variant::Map   CF_ST_LS__qpid_map::qpidmsg_codded_as_qpid_map (void) const
    {   qpid::types::Variant::Map result;  __internal_add2map(result, *this);  return result;  }
...
{
    return ( (static_cast<const CF_XX_LS&>(a)   ==  static_cast<const CF_XX_LS&>(b))  &&           a.request_pos ==  b.request_pos  &&   true  );
};
...
void  copy (sub_position_ls__qpid_map& c, const qpid::types::Variant& v)
    {
        copy(c.m_static, v);
...
void  copy (RQ_XX_LS__qpid_map& c, const qpid::types::Variant& v)
    {
        copy(c.m_static, v);
        c.m_qpid_map = v.asMap();
    }
...
void  copy (RQ_MD_LS__qpid_map& c, const qpid::types::Variant& v)
    {
        copy(c.m_static, v);
        c.m_qpid_map = v.asMap();
    }
...
void  copy (RQ_CC_LS__qpid_map& c, const qpid::types::Variant& v)
    {
        copy(c.m_static, v);
        c.m_qpid_map = v.asMap();
    }
...
void  copy (CF_XX_LS__qpid_map& c, const qpid::types::Variant& v)
    {
        copy(c.m_static, v);
        c.m_qpid_map = v.asMap();
    }
...
void  copy (CF_NW_LS__qpid_map& c, const qpid::types::Variant& v)
    {
        copy(c.m_static, v);
        c.m_qpid_map = v.asMap();
    }
...
void  copy (CF_MD_LS__qpid_map& c, const qpid::types::Variant& v)
    {
        copy(c.m_static, v);
        c.m_qpid_map = v.asMap();
    }
...
void  copy (CF_CC_LS__qpid_map& c, const qpid::types::Variant& v)
    {
        copy(c.m_static, v);
        c.m_qpid_map = v.asMap();
    }
...
void  copy (CF_EX_LS__qpid_map& c, const qpid::types::Variant& v)
    {
        copy(c.m_static, v);
        c.m_qpid_map = v.asMap();
    }
...
void  copy (RJ_XX_LS__qpid_map& c, const qpid::types::Variant& v)
    {
        copy(c.m_static, v);
        c.m_qpid_map = v.asMap();
    }
...
void  copy (RJ_NW_LS__qpid_map& c, const qpid::types::Variant& v)
    {
        copy(c.m_static, v);
        c.m_qpid_map = v.asMap();
    }
...
void  copy (RJ_MD_LS__qpid_map& c, const qpid::types::Variant& v)
    {
        copy(c.m_static, v);
        c.m_qpid_map = v.asMap();
    }
...
void  copy (RJ_CC_LS__qpid_map& c, const qpid::types::Variant& v)
    {
        copy(c.m_static, v);
        c.m_qpid_map = v.asMap();
    }
...
void  copy (CF_ST_LS__qpid_map& c, const qpid::types::Variant& v)
    {
        copy(c.m_static, v);
        c.m_qpid_map = v.asMap();
    }
...
qpid::types::Variant::Map   RQ_MD_LS::qpidmsg_codded_as_qpid_map (void) const
{
    qpid::types::Variant::Map   content;
...
qpid::types::Variant::Map   RQ_CC_LS::qpidmsg_codded_as_qpid_map (void) const
{
    qpid::types::Variant::Map   content;
...
qpid::types::Variant::Map   CF_NW_LS::qpidmsg_codded_as_qpid_map (void) const
{
    qpid::types::Variant::Map   content;
...
qpid::types::Variant::Map   CF_MD_LS::qpidmsg_codded_as_qpid_map (void) const
{
    qpid::types::Variant::Map   content;
...
qpid::types::Variant::Map   CF_CC_LS::qpidmsg_codded_as_qpid_map (void) const
{
    qpid::types::Variant::Map   content;
...
qpid::types::Variant::Map   CF_EX_LS::qpidmsg_codded_as_qpid_map (void) const
{
    qpid::types::Variant::Map   content;
...
qpid::types::Variant::Map   RJ_NW_LS::qpidmsg_codded_as_qpid_map (void) const
{
    qpid::types::Variant::Map   content;
...
qpid::types::Variant::Map   RJ_MD_LS::qpidmsg_codded_as_qpid_map (void) const
{
    qpid::types::Variant::Map   content;
...
qpid::types::Variant::Map   RJ_CC_LS::qpidmsg_codded_as_qpid_map (void) const
{
    qpid::types::Variant::Map   content;
...
qpid::types::Variant::Map   CF_ST_LS::qpidmsg_codded_as_qpid_map (void) const
{
    qpid::types::Variant::Map   content;
...
sub_position_ls::sub_position_ls (const qpid::types::Variant::Map&  mv)
     : //   field_type
...
sub_position_ls__qpid_map::sub_position_ls__qpid_map (const qpid::types::Variant::Map&  mv)
    :  m_static(mv), m_qpid_map(mv)
    {
    }
    

RQ_XX_LS::RQ_XX_LS (const qpid::types::Variant::Map&  mv)
...
RQ_XX_LS__qpid_map::RQ_XX_LS__qpid_map (const qpid::types::Variant::Map&  mv)
    :  m_static(mv), m_qpid_map(mv)
    {
    }
...
RQ_MD_LS::RQ_MD_LS (const qpid::types::Variant::Map&  mv)
     : RQ_XX_LS(mv) 
    {
        copy(*this, mv);
        check_recomended ();  
...
RQ_MD_LS__qpid_map::RQ_MD_LS__qpid_map (const qpid::types::Variant::Map&  mv)
    :  m_static(mv), m_qpid_map(mv)
    {
    }
    

RQ_CC_LS::RQ_CC_LS (const qpid::types::Variant::Map&  mv)
     : RQ_XX_LS(mv) 
    {
        copy(*this, mv);
        check_recomended ();  
...
RQ_CC_LS__qpid_map::RQ_CC_LS__qpid_map (const qpid::types::Variant::Map&  mv)
    :  m_static(mv), m_qpid_map(mv)
    {
    }
    

CF_XX_LS::CF_XX_LS (const qpid::types::Variant::Map&  mv)
...
CF_XX_LS__qpid_map::CF_XX_LS__qpid_map (const qpid::types::Variant::Map&  mv)
    :  m_static(mv), m_qpid_map(mv)
    {
    }
    

CF_NW_LS::CF_NW_LS (const qpid::types::Variant::Map&  mv)
     : CF_XX_LS(mv) 
    {
        copy(*this, mv);
        check_recomended ();  
...
CF_NW_LS__qpid_map::CF_NW_LS__qpid_map (const qpid::types::Variant::Map&  mv)
    :  m_static(mv), m_qpid_map(mv)
    {
    }
    

CF_MD_LS::CF_MD_LS (const qpid::types::Variant::Map&  mv)
     : CF_XX_LS(mv) 
    {
        copy(*this, mv);
        check_recomended ();  
...
CF_MD_LS__qpid_map::CF_MD_LS__qpid_map (const qpid::types::Variant::Map&  mv)
    :  m_static(mv), m_qpid_map(mv)
    {
    }
    

CF_CC_LS::CF_CC_LS (const qpid::types::Variant::Map&  mv)
     : CF_XX_LS(mv) 
    {
        copy(*this, mv);
        check_recomended ();  
...
CF_CC_LS__qpid_map::CF_CC_LS__qpid_map (const qpid::types::Variant::Map&  mv)
    :  m_static(mv), m_qpid_map(mv)
    {
    }
    

CF_EX_LS::CF_EX_LS (const qpid::types::Variant::Map&  mv)
     : CF_XX_LS(mv), //   sub_msg_type
...
CF_EX_LS__qpid_map::CF_EX_LS__qpid_map (const qpid::types::Variant::Map&  mv)
    :  m_static(mv), m_qpid_map(mv)
    {
    }
    

RJ_XX_LS::RJ_XX_LS (const qpid::types::Variant::Map&  mv)
     : CF_XX_LS(mv), //   sub_msg_type
   request_pos(__internal_get_default((sub_position_ls*)0)) 
    {
        copy(*this, mv);
...
RJ_XX_LS__qpid_map::RJ_XX_LS__qpid_map (const qpid::types::Variant::Map&  mv)
    :  m_static(mv), m_qpid_map(mv)
    {
    }
    

RJ_NW_LS::RJ_NW_LS (const qpid::types::Variant::Map&  mv)
     : RJ_XX_LS(mv) 
    {
        copy(*this, mv);
        check_recomended ();  
...
RJ_NW_LS__qpid_map::RJ_NW_LS__qpid_map (const qpid::types::Variant::Map&  mv)
    :  m_static(mv), m_qpid_map(mv)
    {
    }
    

RJ_MD_LS::RJ_MD_LS (const qpid::types::Variant::Map&  mv)
     : RJ_XX_LS(mv) 
    {
        copy(*this, mv);
        check_recomended ();  
...
RJ_MD_LS__qpid_map::RJ_MD_LS__qpid_map (const qpid::types::Variant::Map&  mv)
    :  m_static(mv), m_qpid_map(mv)
    {
    }
    

RJ_CC_LS::RJ_CC_LS (const qpid::types::Variant::Map&  mv)
     : RJ_XX_LS(mv) 
    {
        copy(*this, mv);
        check_recomended ();  
...
RJ_CC_LS__qpid_map::RJ_CC_LS__qpid_map (const qpid::types::Variant::Map&  mv)
    :  m_static(mv), m_qpid_map(mv)
    {
    }
    

CF_ST_LS::CF_ST_LS (const qpid::types::Variant::Map&  mv)
     : CF_XX_LS(mv), //   sub_msg_type
...
CF_ST_LS__qpid_map::CF_ST_LS__qpid_map (const qpid::types::Variant::Map&  mv)
    :  m_static(mv), m_qpid_map(mv)
    {
    }
    
mtk::t_qpid_filter  RQ_NW_LS::get_in_subject (const std::string& invariant_account_client_code,const std::string& invariant_product_code_market,const std::string& invariant_account_name,const std::string& invariant_product_code_product)
    {
    ...
    mtk::t_qpid_filter  RQ_MD_LS::get_in_subject (const std::string& invariant_account_client_code,const std::string& invariant_product_code_market,const std::string& invariant_account_name,const std::string& invariant_product_code_product)
    {
        return mtk::t_qpid_filter(MTK_SS("MK." << invariant_account_client_code << "." << invariant_product_code_market << "." << invariant_account_name << "." << invariant_product_code_product << ".TRD"));
    }
    mtk::t_qpid_filter  RQ_MD_LS::get_out_subject (void) const
    {
        return mtk::t_qpid_filter(MTK_SS("MK." << this->invariant.account.client_code << "." << this->invariant.product_code.market << "." << this->invariant.account.name << "." << this->invariant.product_code.product << ".TRD"));
    }
    /*static*/  mtk::t_qpid_address  RQ_MD_LS::static_get_qpid_address ()
    {
        return mtk::t_qpid_address(MTK_SS("CLI_MK"));
    }
    mtk::t_qpid_address  RQ_MD_LS::get_qpid_address (void) const
    {
        return mtk::t_qpid_address(MTK_SS("CLI_MK"));
    }
    mtk::t_qpid_filter  RQ_CC_LS::get_in_subject (const std::string& invariant_account_client_code,const std::string& invariant_product_code_market,const std::string& invariant_account_name,const std::string& invariant_product_code_product)
    {
        return mtk::t_qpid_filter(MTK_SS("MK." << invariant_account_client_code << "." << invariant_product_code_market << "." << invariant_account_name << "." << invariant_product_code_product << ".TRD"));
    }
    mtk::t_qpid_filter  RQ_CC_LS::get_out_subject (void) const
    {
        return mtk::t_qpid_filter(MTK_SS("MK." << this->invariant.account.client_code << "." << this->invariant.product_code.market << "." << this->invariant.account.name << "." << this->invariant.product_code.product << ".TRD"));
    }
    /*static*/  mtk::t_qpid_address  RQ_CC_LS::static_get_qpid_address ()
    {
        return mtk::t_qpid_address(MTK_SS("CLI_MK"));
    }
    mtk::t_qpid_address  RQ_CC_LS::get_qpid_address (void) const
    {
        return mtk::t_qpid_address(MTK_SS("CLI_MK"));
    }
    mtk::t_qpid_filter  CF_NW_LS::get_in_subject (const std::string& invariant_account_client_code,const std::string& invariant_product_code_market,const std::string& invariant_account_name)
    {
    ...
    mtk::t_qpid_filter  CF_NW_LS::get_out_subject (void) const
    {
    ...
    /*static*/  mtk::t_qpid_address  CF_NW_LS::static_get_qpid_address ()
    {
        return mtk::t_qpid_address(MTK_SS("CLI_MK"));
    }
    mtk::t_qpid_address  CF_NW_LS::get_qpid_address (void) const
    {
        return mtk::t_qpid_address(MTK_SS("CLI_MK"));
    }
    mtk::t_qpid_filter  CF_MD_LS::get_in_subject (const std::string& invariant_account_client_code,const std::string& invariant_product_code_market,const std::string& invariant_account_name)
    {
        return mtk::t_qpid_filter(MTK_SS("CLI." << invariant_account_client_code << "." << invariant_product_code_market << "." << invariant_account_name << ".TRD"));
    }
    mtk::t_qpid_filter  CF_MD_LS::get_out_subject (void) const
    {
        return mtk::t_qpid_filter(MTK_SS("CLI." << this->invariant.account.client_code << "." << this->invariant.product_code.market << "." << this->invariant.account.name << ".TRD"));
    }
    /*static*/  mtk::t_qpid_address  CF_MD_LS::static_get_qpid_address ()
    {
        return mtk::t_qpid_address(MTK_SS("CLI_MK"));
    }
    mtk::t_qpid_address  CF_MD_LS::get_qpid_address (void) const
    {
        return mtk::t_qpid_address(MTK_SS("CLI_MK"));
    }
    mtk::t_qpid_filter  CF_CC_LS::get_in_subject (const std::string& invariant_account_client_code,const std::string& invariant_product_code_market,const std::string& invariant_account_name)
    {
        return mtk::t_qpid_filter(MTK_SS("CLI." << invariant_account_client_code << "." << invariant_product_code_market << "." << invariant_account_name << ".TRD"));
    }
    mtk::t_qpid_filter  CF_CC_LS::get_out_subject (void) const
    {
        return mtk::t_qpid_filter(MTK_SS("CLI." << this->invariant.account.client_code << "." << this->invariant.product_code.market << "." << this->invariant.account.name << ".TRD"));
    }
    /*static*/  mtk::t_qpid_address  CF_CC_LS::static_get_qpid_address ()
    {
        return mtk::t_qpid_address(MTK_SS("CLI_MK"));
    }
    mtk::t_qpid_address  CF_CC_LS::get_qpid_address (void) const
    {
        return mtk::t_qpid_address(MTK_SS("CLI_MK"));
    }
    mtk::t_qpid_filter  CF_EX_LS::get_in_subject (const std::string& invariant_account_client_code,const std::string& invariant_product_code_market,const std::string& invariant_account_name)
    {
        return mtk::t_qpid_filter(MTK_SS("CLI." << invariant_account_client_code << "." << invariant_product_code_market << "." << invariant_account_name << ".TRD"));
    }
    mtk::t_qpid_filter  CF_EX_LS::get_out_subject (void) const
    {
        return mtk::t_qpid_filter(MTK_SS("CLI." << this->invariant.account.client_code << "." << this->invariant.product_code.market << "." << this->invariant.account.name << ".TRD"));
    }
    /*static*/  mtk::t_qpid_address  CF_EX_LS::static_get_qpid_address ()
    {
        return mtk::t_qpid_address(MTK_SS("CLI_MK"));
    }
    mtk::t_qpid_address  CF_EX_LS::get_qpid_address (void) const
    {
        return mtk::t_qpid_address(MTK_SS("CLI_MK"));
    }
    mtk::t_qpid_filter  RJ_NW_LS::get_in_subject (const std::string& invariant_account_client_code,const std::string& invariant_product_code_market,const std::string& invariant_account_name)
    {
        return mtk::t_qpid_filter(MTK_SS("CLI." << invariant_account_client_code << "." << invariant_product_code_market << "." << invariant_account_name << ".TRD"));
    }
    mtk::t_qpid_filter  RJ_NW_LS::get_out_subject (void) const
    {
        return mtk::t_qpid_filter(MTK_SS("CLI." << this->invariant.account.client_code << "." << this->invariant.product_code.market << "." << this->invariant.account.name << ".TRD"));
    }
    /*static*/  mtk::t_qpid_address  RJ_NW_LS::static_get_qpid_address ()
    {
        return mtk::t_qpid_address(MTK_SS("CLI_MK"));
    }
    mtk::t_qpid_address  RJ_NW_LS::get_qpid_address (void) const
    {
        return mtk::t_qpid_address(MTK_SS("CLI_MK"));
    }
    mtk::t_qpid_filter  RJ_MD_LS::get_in_subject (const std::string& invariant_account_client_code,const std::string& invariant_product_code_market,const std::string& invariant_account_name)
    {
        return mtk::t_qpid_filter(MTK_SS("CLI." << invariant_account_client_code << "." << invariant_product_code_market << "." << invariant_account_name << ".TRD"));
    }
    mtk::t_qpid_filter  RJ_MD_LS::get_out_subject (void) const
    {
        return mtk::t_qpid_filter(MTK_SS("CLI." << this->invariant.account.client_code << "." << this->invariant.product_code.market << "." << this->invariant.account.name << ".TRD"));
    }
    /*static*/  mtk::t_qpid_address  RJ_MD_LS::static_get_qpid_address ()
    {
        return mtk::t_qpid_address(MTK_SS("CLI_MK"));
    }
    mtk::t_qpid_address  RJ_MD_LS::get_qpid_address (void) const
    {
        return mtk::t_qpid_address(MTK_SS("CLI_MK"));
    }
    mtk::t_qpid_filter  RJ_CC_LS::get_in_subject (const std::string& invariant_account_client_code,const std::string& invariant_product_code_market,const std::string& invariant_account_name)
    {
        return mtk::t_qpid_filter(MTK_SS("CLI." << invariant_account_client_code << "." << invariant_product_code_market << "." << invariant_account_name << ".TRD"));
    }
    mtk::t_qpid_filter  RJ_CC_LS::get_out_subject (void) const
    {
        return mtk::t_qpid_filter(MTK_SS("CLI." << this->invariant.account.client_code << "." << this->invariant.product_code.market << "." << this->invariant.account.name << ".TRD"));
    }
    /*static*/  mtk::t_qpid_address  RJ_CC_LS::static_get_qpid_address ()
    {
        return mtk::t_qpid_address(MTK_SS("CLI_MK"));
    }
    mtk::t_qpid_address  RJ_CC_LS::get_qpid_address (void) const
    {
        return mtk::t_qpid_address(MTK_SS("CLI_MK"));
    }
