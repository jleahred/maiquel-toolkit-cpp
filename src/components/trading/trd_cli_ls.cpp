...
#define CHECK_REQUEST_MOD_AND_WRITE_LAST_REQ \
    {   \
        ...
        ci->__serrors += tresult._1;    \
        mtk::tuple<int, std::string, bool> tresult2;    \
        tresult2 = mtk::trd::msg::check_request_last_confirm<mtk::trd::msg::RQ_XX_LS, mtk::trd::msg::CF_XX_LS>(rq, last_confirmation()   ); \
        nerrors += tresult2._0;    \
        ci->__serrors += tresult2._1;    \
        qty_lower_exec = tresult2._2;    \
...
#define CREATE_AND_SEND_REJECT(__SIGNAL_TYPE__, __MSG_TYPE__, __DESCRIPTION__) \
    ...
    {               \
        ...
        cptr_rj = mtk::make_cptr(new mtk::trd::msg::__MSG_TYPE__(mtk::trd::msg::RJ_XX_LS(rjxx, __DESCRIPTION__, last_request().Get().request_pos))); \
