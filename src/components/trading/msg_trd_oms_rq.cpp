...
//void  __internal_qpid_fill (oms_RQ_NW_LS& c, std::map<qpid::messaging::MapView::key_type, qpid::messaging::Variant> mv)
void  copy (oms_RQ_NW_LS& c, const qpid::messaging::Variant& v)
    {  
...
void __internal_add2map (qpid::messaging::Variant::Map& map, const oms_RQ_NW_LS& a)
{
...
void __internal_add2map (qpid::messaging::MapContent& map, const oms_RQ_NW_LS& a)
{
...
//void  __internal_qpid_fill (oms_RQ_MD_LS& c, std::map<qpid::messaging::MapView::key_type, qpid::messaging::Variant> mv)
void  copy (oms_RQ_MD_LS& c, const qpid::messaging::Variant& v)
    {  
        const std::map<qpid::messaging::MapView::key_type, qpid::messaging::Variant> mv = v.asMap();
...
void __internal_add2map (qpid::messaging::Variant::Map& map, const oms_RQ_MD_LS& a)
{
...
void __internal_add2map (qpid::messaging::MapContent& map, const oms_RQ_MD_LS& a)
{
...
//void  __internal_qpid_fill (oms_RQ_CC_LS& c, std::map<qpid::messaging::MapView::key_type, qpid::messaging::Variant> mv)
void  copy (oms_RQ_CC_LS& c, const qpid::messaging::Variant& v)
    {  
        const std::map<qpid::messaging::MapView::key_type, qpid::messaging::Variant> mv = v.asMap();
...
void __internal_add2map (qpid::messaging::Variant::Map& map, const oms_RQ_CC_LS& a)
{
...
void __internal_add2map (qpid::messaging::MapContent& map, const oms_RQ_CC_LS& a)
{
