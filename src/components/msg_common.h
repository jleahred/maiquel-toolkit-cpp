...
public:
    ...
    void check_recomended(void) const;
        ...
        public:
            ...
            explicit  sub_process_info__qpid_map (    const sub_location&  _location,   const std::string&  _process_name,   const std::string&  _process_uuid,   const std::string&  _version );
