...
std::string  req_login_key::get_in_subject (const std::string& request_info_process_location_location_client_code)
    ...
    std::string  res_login_key::get_in_subject (const std::string& response_info_request_info_process_location_location_client_code,const std::string& response_info_request_info_process_location_location_machine,const std::string& response_info_request_info_process_location_process_uuid,const std::string& response_info_request_info_req_id_sess_id,const std::string& response_info_request_info_req_id_req_code)
    {
        return MTK_SS("RS." << response_info_request_info_process_location_location_client_code << "." << response_info_request_info_process_location_location_machine << "." << response_info_request_info_process_location_process_uuid << "." << response_info_request_info_req_id_sess_id << "." << response_info_request_info_req_id_req_code << ".RSK");
    }
    ...
    std::string  req_login::get_in_subject (const std::string& request_info_process_location_location_client_code)
    {
        return MTK_SS("RQ." << request_info_process_location_location_client_code << ".ACS.RQL");
    }
    std::string  req_login::get_out_subject (void) const
    {
        return MTK_SS("RQ." << this->request_info.process_location.location.client_code << ".ACS.RQL");
    }
    std::string  res_login::get_in_subject (const std::string& response_info_request_info_process_location_location_client_code,const std::string& response_info_request_info_process_location_location_machine,const std::string& response_info_request_info_process_location_process_uuid,const std::string& response_info_request_info_req_id_sess_id,const std::string& response_info_request_info_req_id_req_code)
    {
        return MTK_SS("RS." << response_info_request_info_process_location_location_client_code << "." << response_info_request_info_process_location_location_machine << "." << response_info_request_info_process_location_process_uuid << "." << response_info_request_info_req_id_sess_id << "." << response_info_request_info_req_id_req_code << ".LRES");
    }
    ...
    std::string  req_logout::get_in_subject (const std::string& request_info_process_location_location_client_code)
    {
        return MTK_SS("RQ." << request_info_process_location_location_client_code << ".ACS.RQK");
    }
