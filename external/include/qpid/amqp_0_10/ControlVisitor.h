...
struct ControlVisitor
{
    ...
    virtual void visit(cluster-connection::ManagementSchema&) = 0;
    virtual void visit(cluster-connection::ManagementSetupState&) = 0;
    virtual void visit(cluster-connection::ManagementAgents&) = 0;
};
struct ConstControlVisitor
{
    ...
    virtual void visit(const cluster-connection::ManagementSchema&) = 0;
    virtual void visit(const cluster-connection::ManagementSetupState&) = 0;
    virtual void visit(const cluster-connection::ManagementAgents&) = 0;
};
