    ...
    public Control
{
    ...
    static const char* NAME;
    static const uint8_t CODE=0x35;
    static const uint8_t CLASS_CODE=cluster_connection::CODE;
    static const char* CLASS_NAME;
    explicit ManagementSchema(const Vbin32& data_=Vbin32());
    void accept(Visitor&);
    void accept(ConstVisitor&) const;
    template <class S> void serialize(S& s) {
        s(data);
    ...
    struct Handler
    {
        void clusterConnectionManagementSchema(
            const Vbin32& data_
        );
    };
    ...
    template <class T> void invoke(T& target)const
    {
        target.clusterConnectionManagementSchema(data );
    }
};
inline Packer<ManagementSchema> serializable(ManagementSchema& x) { return Packer<ManagementSchema>(x); }
std::ostream& operator << (std::ostream&, const ManagementSchema&);
bool operator==(const ManagementSchema&, const ManagementSchema&);
    ...
    public Control
{
    ...
    template <class T> void invoke(T& target)const
    {
        target.clusterConnectionManagementSetupState(objectNum, bootSequence );
    }
};
    ...
    public Control
{
    ...
    static const uint8_t CLASS_CODE=cluster_connection::CODE;
    static const char* CLASS_NAME;
    explicit ManagementAgents(const Vbin32& data_=Vbin32());
    void accept(Visitor&);
    void accept(ConstVisitor&) const;
    template <class S> void serialize(S& s) {
        s(data);
    ...
    struct Handler
    {
        void clusterConnectionManagementAgents(
            const Vbin32& data_
        );
    };
    ...
    template <class T> void invoke(T& target)const
    {
        target.clusterConnectionManagementAgents(data );
    }
};
inline Packer<ManagementAgents> serializable(ManagementAgents& x) { return Packer<ManagementAgents>(x); }
std::ostream& operator << (std::ostream&, const ManagementAgents&);
bool operator==(const ManagementAgents&, const ManagementAgents&);
