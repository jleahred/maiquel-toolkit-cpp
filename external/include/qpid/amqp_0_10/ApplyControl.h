    ...
    public ApplyVisitorBase<ControlVisitor, F>
{
    ...
    virtual void visit(cluster-connection::ManagementSchema& x) { this->invoke(x); }
    virtual void visit(cluster-connection::ManagementSetupState& x) { this->invoke(x); }
    virtual void visit(cluster-connection::ManagementAgents& x) { this->invoke(x); }
};
template <class F>
    ...
    public ApplyVisitorBase<ConstControlVisitor, F>
{
    ...
    virtual void visit(const cluster-connection::ManagementSchema& x) { this->invoke(x); }
    virtual void visit(const cluster-connection::ManagementSetupState& x) { this->invoke(x); }
    virtual void visit(const cluster-connection::ManagementAgents& x) { this->invoke(x); }
};
