    ...
    public MethodBodyConstVisitor
{
    ...
    QPID_COMMON_EXTERN virtual void visit(const ClusterConnectionManagementSchemaBody&);
    QPID_COMMON_EXTERN virtual void visit(const ClusterConnectionManagementSetupStateBody&);
    QPID_COMMON_EXTERN virtual void visit(const ClusterConnectionManagementAgentsBody&);
};
