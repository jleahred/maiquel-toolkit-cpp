    ...
    public Proxy
{
  public:
        ...
        public Proxy
    {
        ...
        QPID_COMMON_EXTERN virtual void queue(const std::string& encoded);
        ...
        QPID_COMMON_EXTERN virtual void managementSchema(const std::string& data);
        
        QPID_COMMON_EXTERN virtual void managementSetupState(uint64_t objectNum,
                    uint16_t bootSequence);
        
        QPID_COMMON_EXTERN virtual void managementAgents(const std::string& data);
