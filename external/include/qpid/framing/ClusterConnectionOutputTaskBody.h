...
#define QPID_FRAMING_CLUSTERCONNECTIONOUTPUTTASKBODY_H
/*
 *
...
public:
    ...
    ClusterConnectionOutputTaskBody(ProtocolVersion=ProtocolVersion())  : channel(0), flags(0) {}
    
    QPID_COMMON_EXTERN void setChannel(uint16_t _channel);
    ...
    template <class T> ResultType invoke(T& invocable) const {
        return invocable.outputTask(getChannel(), getName());
    }
...
#endif  /*!QPID_FRAMING_CLUSTERCONNECTIONOUTPUTTASKBODY_H*/
