...
public:
    ...
    QPID_COMMON_EXTERN const Array& getCapabilities() const;
    QPID_COMMON_EXTERN bool hasCapabilities() const;
    QPID_COMMON_EXTERN void clearCapabilitiesFlag();
    QPID_COMMON_EXTERN void setInsist(bool _insist);
    QPID_COMMON_EXTERN bool getInsist() const;
